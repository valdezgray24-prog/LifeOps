      ...
      body: JSON.stringify({
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <h2 style="color: #1a202c;">New Beta Signup!</h2>
            <p>Someone just joined the LifeOps waitlist:</p>
            
            <div style="background-color: #f7fafc; padding: 20px; border-radius: 8px; margin: 20px 0;">
              <p><strong>Name:</strong> ${formData.firstName}</p>
              <p><strong>Email:</strong> ${formData.email}</p>
              <p><strong>Responsibility:</strong> ${formData.responsibility}</p>
              <p><strong>Area of Interest:</strong> ${formData.area}</p>
              <p><strong>Signed up:</strong> ${new Date().toLocaleString()}</p>
            </div>
            
            <p style="color: #718096; font-size: 12px;">
              View all signups in your Supabase dashboard: <a href="https://supabase.com">supabase.com</a>
            </p>
          </div>
        `
      })
...
export default LifeOpsLanding;    if (!formData.email.trim()) {
      errors.email = 'Email is required';
    } else if (!emailRegex.test(formData.email)) {
      errors.email = 'Please enter a valid email address';
    }
